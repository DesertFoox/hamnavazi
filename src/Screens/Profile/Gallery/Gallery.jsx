...
const Gallery = () => {
  return (
    <div className="event   grid grid-cols-1 bg-white rounded border-r-6 border-textcolor mx-sssm mt-ssm">
      <div className="grid py-4 px-4 grid-cols-1 md:mx-auto lg:grid-cols-2">
        <div className="right-side-event">
          ...
          <p className="text-13 mt-ssm">
            ...
            صفحه‌آرایی و طراحی گرافیک گفته می‌شود. طراح گرافیک از این نوشتار به
            عنوان عنصری از ترکیب‌بندی برای پُر کردن صفحه و ارائه اولیه شکل ظاهری
            و کلی طرح سفارش‌گرفته‌شده ‌استفاده می‌کند، تا ازنظر گرافیکی نشان‌گر
            چگونگی نوع و اندازه قلم و ظاهرِ متن باشد. معمولاً طراحان گرافیک برای
            صفحه‌آرایی، نخست از متن‌های آزمایشی و بی‌معنی استفاده می‌کنند تا
            صرفاً به مشتری یا صاحب‌کار خود نشان دهند که صفحه طراحی یا
            صفحه‌بندی‌شده، بعد از این‌که متن در آن قرار گیرد، چگونه به نظر
